...
const PayWith = ({ invoice, currentInvoice, handleInvoiceChoose, title }) => {
  ...
  return (
    <div className='absolute top-0 left-0 h-screen w-full bg-black bg-opacity-90 flex justify-center items-center px-6'>
